...
- **Face enrollment UI** — Uusi Faces-tabi Settingsissa: rekisteröityjen kasvojen lista (name, camera, samples, last_seen), Delete-nappi, Enroll New Face -lomake (name + Capture).
...
- **FaceDatabase.delete_face()** — kasvojen poisto tietokannasta.
